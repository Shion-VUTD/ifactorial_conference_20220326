...
for page in range(1,3): # ミスチルの歌詞ページは2ページなので、範囲は1-2。
    ...
    for link in links:
            ...
            # 曲名を取得
            song_name = soup.find('a', class_="td1").text
...
#csv保存
list_df.to_csv('/Users/yamashitashiori/Desktop/Python3/ifactorial_conference_20220326/lyric_test.csv', mode = 'w', encoding='utf-8',index=False)
