...
for page in range(1,2): # 米津玄師の歌詞ページは1ページなので、範囲は1-2。
    base_url = 'https://www.uta-net.com'

    #歌詞一覧ページ
    url = 'https://www.uta-net.com/artist/12795/0/' + str(page) + '/'
...
#csv保存
list_df.to_csv('/Users/yamashitashiori/Desktop/Python3/ifactorial_conference_20220326/lyric_kenshiyonezu.csv', mode = 'w', encoding='utf-8',index=False)
